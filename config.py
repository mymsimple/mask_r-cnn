...
# 数据划分比例
__C.COMMON.TEST_PERCENT = 0.85
__C.COMMON.VAL_PERCENT = 0.15
...
__C.TRAIN.COCO_TRAIN_IMAGE_PATH = os.path.join(__C.COMMON.RELATIVE_PATH, "data/labelme")

__C.TRAIN.COCO_VAL_ANN_PATH = os.path.join(__C.COMMON.RELATIVE_PATH, "infos/val_data.json")
__C.TRAIN.COCO_VAL_IMAGE_PATH = os.path.join(__C.COMMON.RELATIVE_PATH, "data/labelme")
...
__C.TRAIN.FIRST_STAGE_N_EPOCH = 6#32
# n_epoch for convergence loss
__C.TRAIN.MIDDLE_STAGE_N_EPOCH = 24#128
# n_epoch for fine-tuning
__C.TRAIN.LAST_STAGE_N_EPOCH = 48#256
...
__C.TRAIN.STEPS_PER_EPOCH = 50 #1000

# Number of validation steps to run at the end of every training epoch.
# A bigger number improves accuracy of validation stats, but slows
# down the training.
__C.TRAIN.VALIDATION_STEPS = 25#50
...
# model 文件路径
__C.TEST.COCO_MODEL_PATH = os.path.join(__C.COMMON.RELATIVE_PATH, "models/mask_rcnn_coco_0050.h5")
...
__C.TEST.PREDICTION_PATH = os.path.join(__C.COMMON.RELATIVE_PATH, "data/test/prediction/")
__C.TEST.DEBUG_IMAGE_PATH = os.path.join(__C.COMMON.RELATIVE_PATH, "data/test/debug/")
...
__C.TEST.DETECTION_NMS_THRESHOLD = 0.5
#__C.TEST.DETECTION_SCORE_THRESHOLD = 0.9
